...
class Pressapps_Accordion_Faq {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Pressapps_Accordion_Faq_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name  = 'pressapps-accordion-faq';
		$this->version      = '1.0.0';
	 ...
	 *
	 * - Pressapps_Accordion_Faq_Loader. Orchestrates the hooks of the plugin.
	 * - Pressapps_Accordion_Faq_i18n. Defines internationalization functionality.
	 * - Pressapps_Accordion_Faq_Admin. Defines all hooks for the admin area.
	 * - Pressapps_Accordion_Faq_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-pressapps-accordion-faq-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-pressapps-accordion-faq-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-pressapps-accordion-faq-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-pressapps-accordion-faq-public.php';

		$this->loader = new Pressapps_Accordion_Faq_Loader();
	 ...
	 *
	 * Uses the Pressapps_Accordion_Faq_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Pressapps_Accordion_Faq_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Pressapps_Accordion_Faq_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Pressapps_Accordion_Faq_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Pressapps_Accordion_Faq_Loader    Orchestrates the hooks of the plugin.
	 */
